...
public abstract class FtpCmd implements Runnable {
    ...
    protected static void dispatchCommand(SessionThread session, String inputString) {
        ...
        for (CmdMap cmdClass : cmdClasses) {

            if (cmdClass.getName().equals(verb)) {
                ...
                try {
                    constructor = cmdClass.getCommand().getConstructor(new Class[]{SessionThread.class, String.class});
        ...
        } else if (cmdInstance.getClass().equals(CmdUSER.class) || cmdInstance.getClass().equals(CmdPASS.class) || cmdInstance.getClass().equals(CmdQUIT.class)) {
            cmdInstance.run();
        } else {
