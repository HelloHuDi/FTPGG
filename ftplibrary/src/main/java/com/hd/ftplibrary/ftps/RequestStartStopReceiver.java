...
public class RequestStartStopReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            } else if (FsService.ACTION_STOP_FTPSERVER.equals(intent.getAction())) {
                Intent serverService = new Intent(context, FsService.class);
    ...
    private void warnIfNoExternalStorage() {
        ...
        if (!storageState.equals(Environment.MEDIA_MOUNTED)) {
            ...
            Toast toast = Toast.makeText(FTPApp.getAppContext(), R.string.storage_warning, Toast.LENGTH_LONG);
